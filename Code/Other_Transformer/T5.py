...
output_dir = '/home/ubuntu/NLP/Final_Project'
...
LR = 0.001  # Learning rate 3e-4, 5e-5, 3e-5, 2e-5
...
def train_and_val(train_dataloader, val_dataloader):
    ...
    plt.plot(df_stats['ROUGE1'], marker='o', linestyle='dashed', color='green', label="ROUGE1")
    plt.plot(df_stats['ROUGE2'], marker='o', linestyle='dashed', color='blue', label="ROUGE2")
    plt.plot(df_stats['ROUGEL'], marker='*', linestyle='dashed', color='red', label="ROUGEL")
    plt.plot(df_stats['ROUGELSUM'], marker='*', linestyle='dashed', color='cyan', label="ROUGELSUM")
...
#     article = train_df["text"][idx]
#     summary = summarizer(article)[0]["summary_text"]
#     print(f"'>>> Review: {article}'")
#     print(f"\n'>>> Summary: {summary}'")
